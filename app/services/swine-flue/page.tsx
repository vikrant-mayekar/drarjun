  ...
  return (
    <main className="flex min-h-screen flex-col">
      ...
      <section className="relative w-full h-[400px] md:h-[500px]">
        <Image
          src="/images/swine-flu-banner.jpg"
          alt="Swine Flu (H1N1) Care"
          fill
      ...
      <div className="container mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="w-full md:w-3/4 bg-white rounded-lg shadow-lg p-6">
            ...
            <img src="/services/swine-flu.png" alt="Swine Flu" className="w-full h-auto rounded-lg shadow-lg position-center top-0 left-0 mb-4" />
